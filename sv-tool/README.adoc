 ...
 * If not on a system where Supervisor installed: clone Supervisor with 'git clone https://github.com/ECP-CANDLE/Supervisor.git' and then add to PATH with 'export PATH=~/path/to/Supervisor/bin:$PATH' 
+
